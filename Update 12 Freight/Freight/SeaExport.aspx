                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="container">
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link" data-toggle="tab" href="#menu1">Job Details</a>
                                                    </li>                                                   
                                                </ul>
                                            ...
                                            <div class="card" style="fit-position:center; padding-left:10px;  padding-bottom:10px; padding-right:10px; padding-top:10px">
                                                <div class="header">
                                                 ...
                                                 <div class="row">
                                                            ...
                                                            <asp:Button ID="btnPreview" runat="server" Text="Cover Page"  class="btn btn-info btn-fill pull-right" OnClick="btnPreview_Click1" /> 
                                                           ...
                                                           <rsweb:ReportViewer ID="ReportViewer1" runat="server" class="col-md-12"  Width="100%" DocumentMapWidth="100%" Visible="False"></rsweb:ReportViewer>
