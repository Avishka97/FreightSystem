                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="container">
                                            ...
                                            <ul class="nav nav-tabs" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="#menu5">Attached Sheet</a>
                                                </li>
                                            </ul>
                                                                        ...
                                                                        <div class="col-md-4">
                                                                         ...
                                                                         <div class="col-md-4">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <asp:DropDownList ID="cmbBLType"  class="form-control" runat="server">
                                                                                    <asp:ListItem Selected="True">ORIGINAL</asp:ListItem>
                                                                                    <asp:ListItem>COPY NON-NEGOTIABLE</asp:ListItem>
                                                                                    <asp:ListItem>SEAWAY B/L</asp:ListItem>
                                                                                </asp:DropDownList>                                             
                                                                            </div>
                                                                        </div>                          
                                                             ...
                                                             <div class="row">
                                                                     <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <asp:TextBox ID="txtDescription" runat="server"  class="form-control" placeholder="Description"  TextMode="MultiLine" Rows="15"></asp:TextBox>                                                
                                                                        </div>
                                                                    </div>                           
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                ...
                                                <div class="card" style="fit-position:center; padding-left:10px;  padding-bottom:10px; padding-right:10px; padding-top:10px">
                                                    <div class="header">
                                                     ...
                                                     <div class="row">
                                                                 <div class="col-md-6">
                                                                    <div class="form-group">
                                                                         ...
                                                                         <div class="form-check-inline  form-control col-md-6" style="fit-position:center; padding-left:10px">
                                                                              <label class="form-check-label">
                                                                                  <asp:CheckBox ID="chkAttachedSheet" runat="server" class="form-check-input" OnCheckedChanged="chkAttachedSheet_CheckedChanged" AutoPostBack="True"/> 
                                                                                Attached Sheet
                                                                              </label>
                                                                         </div>
                                                     ...
                                                     <div class="row">
                                                             <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Attached Sheet Marks and Numbers</label>
                                                                    <asp:TextBox ID="txtATMarksAndNumbers" runat="server"  class="form-control" placeholder="Attached Sheet Marks and Numbers"  TextMode="MultiLine" Columns="4" ReadOnly="True"></asp:TextBox>                                                
                                                                </div>
                                                            </div>                           
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Attached Sheet Container Numbers</label>
                                                                    <asp:TextBox ID="txtATContainerNo" runat="server"  class="form-control" placeholder="Attached Sheet Container Numbers" TextMode="MultiLine" ReadOnly="True"></asp:TextBox>                                                
                                                                </div>
                                                            </div>
                                                        </div>
                                                     ...
                                                     <div class="row">
                                                             <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label>Attached Sheet Description</label>
                                                                    <asp:TextBox ID="txtATDescription" runat="server"  class="form-control" placeholder="Attached Sheet Description"  TextMode="MultiLine" Columns="4" ReadOnly="True"></asp:TextBox>                                                
                                                                </div>
                                                            </div>
                                                    </div>
                                            ...
                                            <asp:Button ID="btnInvoice" runat="server" Text="Invoice"  class="btn btn-info btn-fill pull-right" OnClick="btnInvoice_Click" /> 
