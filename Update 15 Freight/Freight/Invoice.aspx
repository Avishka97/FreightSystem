                                                ...
                                                <br />
                                                 ...
                                                 <div class="row">
                                                   ...
                                                   <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Invoice ID</label>
                                                            <asp:TextBox ID="txtCBLID" runat="server" class="form-control" placeholder="Invoice ID" ReadOnly="True"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    </div>
                                                ...
                                                <br />
                                                 ...
                                                 <div class="row">
                                                     ...
                                                     <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label>Invoice ID</label>
                                                            <asp:TextBox ID="txtBInvoiceID" runat="server" class="form-control" placeholder="Invoice ID" ReadOnly="True"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    </div>
                                               ...
                                               <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="card" style="fit-position:center; padding-left:10px;  padding-bottom:10px; padding-right:10px; padding-top:10px">
                                                                ...
                                                                <div class="table table-responsive table-fit">
                                                                    <asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" ShowFooter="True" DataKeyName="BillableItemID" CssClass="table table-striped table-bordered table-hover" OnRowCommand="GridView2_RowCommand" OnRowEditing="GridView2_RowEditing" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowUpdating="GridView2_RowUpdating" OnRowDeleting="GridView2_RowDeleting">
                                                                        <AlternatingRowStyle BackColor="White" />
                                                                        <EditRowStyle BackColor="#2461BF" />
                                                                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                                                                        <HeaderStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
