    ...
    public partial class SeaImport : System.Web.UI.Page
    {
        ...
        protected void btnBL_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["POD"] = txtPortDischarge.Text;
                Session["POL"] = txtPortLoading.Text;
                Session["FinalDestination"] = txtFinalDestination.Text;
                Session["Vesel"] = txtVesel.Text;
                Session["LCL_FCL"] = LCL_FCL;
                Session["Shipper"] = txtCompany.Text;
                Session["shipperAdd"] = txtAdd.Text;
                HttpContext.Current.Response.Redirect("BL.aspx", true);
            }
            catch (Exception ex)
            {
