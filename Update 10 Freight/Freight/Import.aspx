                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <asp:Button ID="btnArivalNotice" runat="server" Text="Arival Notice"  class="btn btn-info btn-fill pull-right" />

                                             <asp:Button ID="btnXML" runat="server" Text="Create XML"  class="btn btn-info btn-fill pull-right"/>

                                            <asp:Button ID="btnManifest" runat="server" Text="Create Manifest"  class="btn btn-info btn-fill pull-right"/>


                                            <asp:Button ID="btnInvoice" runat="server" Text="Create Invoice"  class="btn btn-info btn-fill pull-right"/>
