...
namespace Freight
{
    public partial class Invoice : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string ETA = dt.Rows[0].Field<string>("ETA");
            ...
            string SOB = dt.Rows[0].Field<string>("SOB");
        ...
        void PopulateGridview()
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("select * from BillItems where InvoiceID ='"+txtInvoiceID.Text+"' ", sqlCon);
                sqlDa.Fill(dtbl);
            }
        ...
        void PopulateGridview1()
        {
            ...
            {
                sqlCon.Open();
                SqlDataAdapter sqlDa = new SqlDataAdapter("select * from BillableItems where InvoiceID ='" + txtInvoiceID.Text + "' ", sqlCon);
                sqlDa.Fill(dtbl);
            }
            if (dtbl.Rows.Count > 0)
            {
